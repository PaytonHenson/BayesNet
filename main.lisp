(defun example1 ()
  (let* ((c nil)
    ...
    (print-network nodes)
    (format t "RESULT: ~a ~%" (aref (get 'd 'probs) 1))))
...
(defun example2 ()
  (let* ((a nil)
    ...
    (setf (get 'a 'cpt) (make-array '2 :initial-contents '(0.9 0.1)))
    (setf (get 'a 'probs) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
    (setf (get 'a 'lambda-values) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    ...
    (setf (get 'b 'cpt) (make-array '(2 2) :initial-contents '((0.8 0.2) (0.3 0.7))))
    (setf (get 'b 'probs) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
    (setf (get 'b 'lambda-values) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    (setf (get 'b 'lambda-messages) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    ...
    (setf (get 'c 'children) nil)
    (setf (get 'c 'instantiated) nil)
    (setf (get 'c 'cpt) (make-array '(2 2) :initial-contents '((0.999 0.001) (0.6 0.4))))
    (setf (get 'c 'probs) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
    (setf (get 'c 'lambda-values) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    (setf (get 'c 'lambda-messages) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    (setf (get 'c 'pi-values) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
    ...
    (setf (get 'd 'instantiated) nil)
    (setf (get 'd 'cpt) (make-array '(2 2) :initial-contents '((0.6 0.4) (0.2 0.8))))
    (setf (get 'd 'probs) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
    (setf (get 'd 'lambda-values) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    (setf (get 'd 'lambda-messages) (make-array '2 :element-type 'double-float :initial-contents '(1 1)))
    (setf (get 'd 'pi-values) (make-array '2 :element-type 'double-float :initial-element 0.0d0))
